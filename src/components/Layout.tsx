        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-shrink-0 flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
            <img
              ...
              className={`h-12 w-auto transition-all duration-300 ${!scrolled ? 'mix-blend-screen invert grayscale brightness-200' : 'mix-blend-multiply'}`}
            />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1">
          <img
            src="/Hengkang-Webpage/assets/images/logo.png"
            alt="Hengkang Technology"
            className="h-14 w-auto mb-4 mix-blend-screen invert grayscale brightness-200"
          />
